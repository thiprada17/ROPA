...
import { ProcessorData } from "./steps/Step7Precessor";
...
function normalizeStepErrors<T extends Record<string, any>>(errors?: Partial<Record<keyof T, boolean>>): Record<keyof T, boolean> {
...
export default function StepContent<FormDataType extends Record<string, any>>({
  step, formData, errors, updateField, step7Props,}: StepContentProps<FormDataType>) {
  switch (step) {
    case 0:
      return (
        <Step1Activity
    ...
    case 1:
      return (
        <Step2DataType
          ...
          errors={normalizeStepErrors(errors.step2)} // <-- แก้ตรงนี้
          updateField={(f, v) => updateField("step2", f, v)}
        />
      );
    case 2:
      return (
    ...
    case 6:
      return step7Props ? <Step7Processor processors={step7Props.processors} updateProcessors={step7Props.updateProcessors} setIsEditingProcessor={step7Props.setIsEditingProcessor} /> : null;
    default:
      return null;
  }
}
